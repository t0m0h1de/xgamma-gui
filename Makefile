#############################################################################
# Makefile for building: XgammaGui
# Generated by qmake (3.0) (Qt 5.0.1) on: ?? 10? 19 21:30:39 2013
# Project:  XgammaGui.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 -o Makefile XgammaGui.pro
#############################################################################
...
Makefile: XgammaGui.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 -o Makefile XgammaGui.pro
...
dist: 
	@test -d .tmp/XgammaGui1.0.0 || $(MKDIR) .tmp/XgammaGui1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/XgammaGui1.0.0/ && $(COPY_FILE) --parents res/resource.qrc .tmp/XgammaGui1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/XgammaGui1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/XgammaGui1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/XgammaGui1.0.0/ && (cd `dirname .tmp/XgammaGui1.0.0` && $(TAR) XgammaGui1.0.0.tar XgammaGui1.0.0 && $(COMPRESS) XgammaGui1.0.0.tar) && $(MOVE) `dirname .tmp/XgammaGui1.0.0`/XgammaGui1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/XgammaGui1.0.0
...
qrc_resource.cpp: res/resource.qrc \
		res/city1.jpg \
		res/gamma.jpg \
		res/people1.jpg
	/usr/lib/x86_64-linux-gnu/qt5/bin/rcc -name resource res/resource.qrc -o qrc_resource.cpp
